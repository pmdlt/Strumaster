<template>
    <div id="app">
        <form class="vue-form" @submit.prevent="submit">
            ...
            <fieldset>
                <legend>Debug Stepper</legend>
                <div>
                    <label class="label" for="id">Stepper id</label>
                    <input type="text" name="id" id="id" required="" v-model="id">
                </div>
                <div>
                    <label class="label" for="value">Value</label>
                    <input type="value" name="value" id="value" required="" v-model="value">
                </div>
                <div>
                    <h4>Function</h4>
                    <p class="select">
                        <select class="budget" v-model="func">
                            <option value="1">moveTo</option>
                            <option value="2">move</option>
                            <option value="3">currentPosition</option>
                            <option value="4">distanceToGo</option>
                            <option value="5">setMaxSpeed</option>
                            <option value="6">setAcceleration</option>
                        </select>
                    </p>
                </div>
